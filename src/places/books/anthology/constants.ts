...
export const ANTHOLOGY_IMAGES: ImageCatalog = {
  snowflakeLeft: {
    path: new URL('../../../assets/images/books/anthology/snowflake.png?as=webp', import.meta.url),
    alt: 'go back'
  },
  snowflakeRight: {
    path: new URL('../../../assets/images/books/anthology/snowflake.png?as=webp', import.meta.url),
  ...
  arrowLeft: {
    path: new URL('../../../assets/images/arrow-left-red.png?as=webp', import.meta.url),
    alt: 'go back',
    shouldHide: true,
  },
  arrowRight: {
    path: new URL('../../../assets/images/arrow-right-red.png?as=webp', import.meta.url),
    alt: 'go forward',
    shouldHide: true,
  },
}
export const ANTHOLOGY_CHAPTERS: Chapters = [
  [
      {
...
And Eternity in an hour`,
      ...
      {   
          text: `With thanks to the internet for public-domain literature`,
          leftImage: ANTHOLOGY_IMAGES.arrowLeft,
          rightImage: ANTHOLOGY_IMAGES.arrowRight,
      },
  ],
  [
      {
          ...
          leftImage: ANTHOLOGY_IMAGES.arrowLeft,
          heading: 'from The Months',
          text: `by Sara Coleridge

January brings the snow,
makes our feet and fingers glow.`
      },
      {
          heading: 'The Snow Man',
...
“Anything; and the sooner you begin the better! for until you are at home, you will find it as difficult to get out as it is to get in.”`,
      ...
      {
          text: `“I have, unfortunately, found it too easy to get in; once out I shall not try again!”
...
As he spoke, he turned his back, and instantly I knew him. He was no longer a raven, but a man above the middle height with a stoop, very thin, and wearing a long black tail-coat. Again he turned, and I saw him a raven.`,
      ...
      {
          canShow: () => true, // canShowWiseWoman,
          heading: 'The Wise Woman\'s Song',
          leftImage: ANTHOLOGY_IMAGES.snowflakeLeft,
          rightImage: ANTHOLOGY_IMAGES.snowflakeRight,
          text: `by George MacDonald
...
The old woman is very cold.`
      ...
      {
        heading: 'Spelt from Sibyl\'s Leaves',
        leftImage: ANTHOLOGY_IMAGES.snowflakeLeft,
        rightImage: ANTHOLOGY_IMAGES.snowflakeRight,
